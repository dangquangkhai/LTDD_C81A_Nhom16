package com.app.musicapp.ui.bottomsheet;
...
public class SortOrderBottomSheet extends BottomSheetDialogFragment {
    ...
    void onSortTextClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.by_title_text:
                updateAndNotifyNewSort(order_add);
                break;
            case R.id.last_added_text:
                updateAndNotifyNewSort(order_add + 1);
                break;
            case R.id.most_played_text:
                updateAndNotifyNewSort(order_add + 2);
                break;
        }
    }
    ...
    void onOrderTextClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.asc_text:
                updateAndNotifyNewSort(sort_add);
                break;
            case R.id.desc_text:
                updateAndNotifyNewSort(sort_add + 3);
                break;
        }
    }
